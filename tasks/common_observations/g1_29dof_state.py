...
def get_robot_boy_joint_states(
    ...
    # .torch gives a zero-copy torch.Tensor view of the underlying warp array (Isaac Lab 3.0
    # ProxyArray); the raw ProxyArray's .device/.dtype are warp types, not torch ones.
